...
(function() { "use strict";
    ...
    e.defaults = { global: { animation: !0, animationSteps: 60, animationEasing: "easeOutQuart", showScale: !0, scaleOverride: !1, scaleSteps: null, scaleStepWidth: null, scaleStartValue: null, scaleLineColor: "rgba(0,0,0,0)", scaleLineWidth: 1, scaleShowLabels: 0, scaleLabel: "<%=value%>", scaleIntegersOnly: !0, scaleBeginAtZero: !1, scaleFontFamily: "'Helvetica Neue', 'Helvetica', 'Arial', sans-serif", scaleFontSize: 12, scaleFontStyle: "normal", scaleFontColor: "#666", responsive: !1, maintainAspectRatio: !0, showTooltips: !0, customTooltips: !1, tooltipEvents: ["mousemove", "touchstart", "touchmove", "mouseout"], tooltipFillColor: "rgba(0,0,0,0.8)", tooltipFontFamily: "'Helvetica Neue', 'Helvetica', 'Arial', sans-serif", tooltipFontSize: 18, tooltipFontStyle: "normal", tooltipFontColor: "#fff", tooltipTitleFontFamily: "'Helvetica Neue', 'Helvetica', 'Arial', sans-serif", tooltipTitleFontSize: 14, tooltipTitleFontStyle: "bold", tooltipTitleFontColor: "#fff", tooltipYPadding: 15, tooltipXPadding: 10, tooltipCaretSize: 10, tooltipCornerRadius: 6, tooltipXOffset: 10, tooltipTemplate: "<%if (label){%><%=label%>: <%}%><%= value %>", multiTooltipTemplate: "<%= value %>", multiTooltipKeyBackground: "#fff", onAnimationProgress: function() {}, onAnimationComplete: function() {} } }, e.types = {};
    var s = e.helpers = {},
                        ...
                        var c = [],
                            ...
                            d = function() {
                                var t, i, e, n, o, a = [],
                                    l = [],
                                    r = [];
                                return s.each(this.datasets, function(i) { t = i.points || i.bars || i.segments, t[h] && t[h].hasValue() && a.push(t[h]) }), s.each(a, function(t) { l.push(t.x), r.push(t.y), c.push(s.template(this.options.multiTooltipTemplate, t)), u.push({ fill: t._saved.fillColor || t.fillColor, stroke: t._saved.strokeColor || t.strokeColor }) }, this), o = m(r), e = g(r), n = m(l), i = g(l), { x: n > this.chart.width / 2 ? n : i, y: (o + e) / 2 } }.call(this, h);
        ...
        i.Type.extend({
            ...
            initialize: function(t) {
                ...
                this.ScaleClass = i.Scale.extend({ offsetGridLines: !0, calculateBarX: function(t, i, e) {
                    ...
                    this.eachBars(function(t) { t.restore(["fillColor", "strokeColor"]) }), e.each(i, function(t) { t.fillColor = t.highlightFill, t.strokeColor = t.highlightStroke }), this.showTooltip(i) }), this.BarClass = i.Rectangle.extend({ strokeWidth: this.options.barStrokeWidth, showStroke: this.options.barShowStroke, ctx: this.chart.ctx }), e.each(t.datasets, function(i) {
...
function RangeSliderChart(opts) {
    var ranger = { chartProto: new Chart(opts.chartCTX), datasets: opts.chartData, chartOpts: opts.chartOpts || {}, options: opts, sliderElement: $("<div>").addClass("range-slider").width(opts.chartCTX.canvas.width), _getData: function(min, max) {
            var d = {},
                Datasets = JSON.parse(JSON.stringify(ranger.datasets));
            d.labels = Datasets.labels.splice(min, max - min || 1), d.datasets = [];
            for (var i in Datasets.datasets) {
                var nD = Datasets.datasets[i];
                nD.data = nD.data.splice(min, max - min || 1), d.datasets.push(nD) }
            return d }, _create: function() { ranger.sliderElement.noUiSlider({ start: ranger.options.initial, step: 1, connect: !0, range: { min: 0, max: ranger.datasets.datasets[0].data.length - 1 } }).on({ slide: function(b) { ranger._min = parseInt($(b.target).val()[0]), ranger._max = parseInt($(b.target).val()[1]) }, change: function() { ranger.chart.destroy(), ranger.chart = ranger.chartProto[ranger.options.chartType](ranger._getData(ranger._min, ranger._max), ranger.chartOpts) } }), ranger.sliderElement.insertAfter(opts.chartCTX.canvas), ranger.chart && ranger.chart.destroy(), ranger.chart = ranger.chartProto[ranger.options.chartType](ranger._getData(ranger.options.initial[0], ranger.options.initial[1]), ranger.chartOpts) } };
    return ranger._create(), ranger }
